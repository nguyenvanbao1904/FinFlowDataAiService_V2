...
if __name__ == "__main__":
    ...
    print(f"venv/bin/python scripts/financial_training/run_final_model_pipeline.py \\")
    print(f"  --train-target-year-max 2024 --predict-target-year 2025 \\")
    print(f'  --symbols "{VN100_CSV}" \\')
    print(f"  --out-dir artifacts/models/eval_pipeline")
    print()
    print("# Production pipeline (chatbot dùng):")
    print(f"venv/bin/python scripts/financial_training/run_final_model_pipeline.py \\")
    print(f"  --train-target-year-max 2025 --predict-target-year 2026 \\")
    print(f"  --out-dir artifacts/models/production_pipeline")
