...
INDUSTRY_MACROS: dict[str, tuple[str, ...]] = {
    ...
    "V_N_T_I_KHO_B_I": ("oil_brent_log", "bdry_shipping_etf_log", "usd_vnd_yoy_pct"),
    ...
    "H_A_CH_T": ("rubber_log", "oil_brent_log", "usd_vnd_yoy_pct"),
    "I_N": ("coal_log", "nat_gas_log", "oil_brent_log"),
    "D_NG_C_NH_N": ("cpi_inflation_yoy_pp", "usd_vnd_yoy_pct"),
    "D_C_PH_M_V_C_NG_NGH_SINH_H_C": ("usd_vnd_yoy_pct", "cpi_inflation_yoy_pp"),
    ...
    "D_CH_V_H_TR_T_V_N_THI_T_K": ("gdp_growth_yoy_pct", "interest_loan_short_pct"),
    "KIM_LO_I_C_NG_NGHI_P_KHAI_KHO_NG": ("hrc_log", "iron_ore_log", "coal_log"),
    "DU_L_CH_V_GI_I_TR": ("gdp_growth_yoy_pct", "oil_brent_log", "usd_vnd_yoy_pct"),
    "U_NG": ("sugar_log", "cpi_inflation_yoy_pp", "coffee_log"),
    "TRUY_N_TH_NG": ("gdp_growth_yoy_pct",),
    "B_N_L_CHUNG": ("cpi_inflation_yoy_pp", "gdp_growth_yoy_pct"),
    "NG_N_H_NG": ("interest_deposit_12m_pct", "interest_loan_midlong_pct", "usd_vnd_yoy_pct"),
    "C_KH_CH_T_O_M_Y": ("hrc_log", "usd_vnd_yoy_pct", "iron_ore_log"),
    "H_NG_GIA_D_NG_X_Y_D_NG_NH_C_A": ("interest_loan_midlong_pct", "hrc_log"),
    "C_NG_NGHI_P_CHUNG": ("gdp_growth_yoy_pct", "interest_loan_short_pct"),
    "C_NG_NGH_PH_N_C_NG_V_THI_T_B": ("usd_vnd_yoy_pct", "gdp_growth_yoy_pct"),
    "THI_T_B_I_N_I_N_T": ("hrc_log", "usd_vnd_yoy_pct"),
    "L_M_NGHI_P_V_GI_Y": ("usd_vnd_yoy_pct", "gdp_growth_yoy_pct"),
    "PH_N_M_M_V_D_CH_V_I_N_TO_N": ("gdp_growth_yoy_pct", "usd_vnd_yoy_pct"),
    "T_V_LINH_KI_N_T": ("usd_vnd_yoy_pct", "hrc_log", "interest_loan_midlong_pct"),
    "B_O_HI_M_PHI_NH_N_TH": ("interest_deposit_12m_pct", "cpi_inflation_yoy_pp"),
    "THI_T_B_V_D_CH_V_Y_T": ("usd_vnd_yoy_pct", "cpi_inflation_yoy_pp"),
    "T_I_CH_NH_T_NG_H_P": ("interest_deposit_12m_pct", "gdp_growth_yoy_pct"),
    "B_N_L_TH_C_PH_M_V_D_C_PH_M": ("cpi_inflation_yoy_pp", "gdp_growth_yoy_pct"),
    "H_NG_TI_U_KHI_N": ("gdp_growth_yoy_pct", "cpi_inflation_yoy_pp"),
    "THU_C_L": ("cpi_inflation_yoy_pp", "gdp_growth_yoy_pct"),
    "VI_N_TH_NG_C_NH": ("gdp_growth_yoy_pct", "interest_loan_midlong_pct"),
    "B_O_HI_M_NH_N_TH": ("interest_deposit_12m_pct", "gdp_growth_yoy_pct"),
    "VI_N_TH_NG_DI_NG": ("gdp_growth_yoy_pct", "usd_vnd_yoy_pct"),
}
